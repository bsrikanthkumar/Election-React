...
export const NorthernIndia = () => {
  const [jsonData, setJsonData] = useState(null);
  useEffect(() => {
    axios
      .get("/json/northern-india.json")
      .then((response) => {
  ...
  return (
    <div>
      ...
      <Swiper
        ...
        slidesPerView={5}
        navigation={{
          nextEl: "#northernIndiaNext",
          prevEl: "#northernIndiaPrev",
        }}
        ...
        breakpoints={{
          0: {
            ...
            pagination: {
              el: "#northernIndia .swiper-pagination",
              clickable: true,
            },
            navigation: false,
          ...
          768: {
            slidesPerView: 3,
            navigation: {
              nextEl: "#northernIndia .swiper-button-next",
              prevEl: "#northernIndia .swiper-button-prev",
            },
            pagination: false,
          },
          1024: {
      ...
      {/* </div> */}
      <div id="northernIndiaNext" className="swiper-button-next"></div>
      <div  id="northernIndiaPrev" className="swiper-button-prev"></div>

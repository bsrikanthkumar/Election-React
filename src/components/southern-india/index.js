...
export const SouthernIndia = () => {
  const [jsonData, setJsonData] = useState(null);
  useEffect(() => {
    axios
      .get("/json/southern-india.json")
      .then((response) => {
  ...
  return (
    <div>
      ...
      <Swiper
        ...
        slidesPerView={5}
        navigation={{
          nextEl: "#southernIndia .swiper-button-next",
          prevEl: "#southernIndia .swiper-button-prev",
        }}
        ...
        breakpoints={{
          0: {
            slidesPerView: 1,
            pagination: {
              el: "#southernIndia .swiper-pagination",
              clickable: true,
            },
            navigation: false,
          },

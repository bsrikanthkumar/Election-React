...
export const WesternIndia = () => {
  const [jsonData, setJsonData] = useState(null);
  useEffect(() => {
    axios
      .get("/json/western-india.json")
      .then((response) => {
  ...
  return (
    <div>
      ...
      <Swiper
        ...
        slidesPerView={5}
        navigation={{
          nextEl: "#westernIndia .swiper-button-next",
          prevEl: "#westernIndia .swiper-button-prev",
        }}
        ...
        breakpoints={{
          0: {
            slidesPerView: 1,
            pagination: {
              el: "#westernIndia .swiper-pagination",
              clickable: true,
            },
            navigation: false,
          },
